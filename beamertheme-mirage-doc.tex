...
A \texttt{ltx-talk} theme \texttt{talkthemeMirage.sty} is provided, leveraging on the \href{https://ctan.org/pkg/beamertheme-tcolorbox}{beamertheme-tcolorbox \texttt{ltx-talk} theme}. It's still very experimental, so use at your own risk. See the sample file \texttt{mirage-talk.tex}. 

\switchcolumn

\section{\texttt{ltx-talk}主题}

尝试做了一个适配\texttt{ltx-talk}“蜃楼”主题\texttt{talkthemeMirage.sty}，十分感谢\href{https://ctan.org/pkg/beamertheme-tcolorbox}{beamertheme-tcolorbox \texttt{ltx-talk} 主题}。请参照\texttt{mirage-talk.tex}。目前还很粗糙，请自行斟酌使用。
